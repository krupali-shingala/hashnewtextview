...
public class CustomScaleGestureDetector {
    ...
    public interface OnScaleGestureListener {
        boolean onScale(View view, CustomScaleGestureDetector detector);

        boolean onScaleBegin(View view, CustomScaleGestureDetector detector);

        void onScaleEnd(View view, CustomScaleGestureDetector detector);
    }

    public static class SimpleOnScaleGestureListener implements OnScaleGestureListener {

        public boolean onScale(View view, CustomScaleGestureDetector detector) {
            return false;
        }

        public boolean onScaleBegin(View view, CustomScaleGestureDetector detector) {
            return true;
        }

        public void onScaleEnd(View view, CustomScaleGestureDetector detector) {
            // Intentionally empty
        }
    }
        ...
        if (event.getPointerCount() <= 2) {
            if (mInvalidGesture) {
                ...
                switch (action) {
                    ...
                    case MotionEvent.ACTION_POINTER_DOWN /*| MotionEvent.ACTION_POINTER_1_DOWN | MotionEvent.ACTION_POINTER_2_DOWN*/: {
                ...
                switch (action) {
                    ...
                    case MotionEvent.ACTION_POINTER_UP /*| MotionEvent.ACTION_POINTER_1_UP | MotionEvent.ACTION_POINTER_2_UP*/: {
