...
public class ColorHsvPalette extends BitmapDrawable {
    ...
    public void draw(@NonNull Canvas canvas) {
        ...
        Shader sweepShader = new SweepGradient(centerX, centerY, new int[]{Color.RED, Color.MAGENTA, Color.BLUE, Color.CYAN, Color.GREEN, Color.YELLOW, Color.RED}, new float[]{0.000f, 0.166f, 0.333f, 0.499f, 0.666f, 0.833f, 0.999f});
